...
import com.unutrip.databinding.FragmentItineraryDetailBinding
...
class AISuggestFragment : Fragment() {
    ...
    private var _binding: com.unutrip.databinding.FragmentAiSuggestBinding? = null
    private val binding get() = _binding!!
    private lateinit var itineraryViewModel: ItineraryViewModel
    private lateinit var sessionManager: SessionManager

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = com.unutrip.databinding.FragmentAiSuggestBinding.inflate(inflater, container, false)
        return binding.root
    }
