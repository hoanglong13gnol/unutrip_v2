...
import com.unutrip.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    private fun setupMenu() {
        ...
        binding.settingAbout.tvLabel.text = "Về UNUtrip"
        binding.settingAbout.root.setOnClickListener {
            Toast.makeText(context, "UNUtrip v1.0.0", Toast.LENGTH_SHORT).show()
        }
    }
